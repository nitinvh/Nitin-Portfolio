...
const HighRadiusDetailView = (props) => {
    const { aboutProject } = props;
    return (
        <div className="mx-6">
            <div className="py-5">
                <h6 className="custom-font-size text-theme-color">About Project <span className="text-light fs-1">{`( HighRadius Internship )`}</span> </h6>
            ...
            <div className="py-5">
                ...
                <ul className="fs-3 third-theme-clr py-5">
                    {aboutProject.developmentJourney.testAndProject.map((point, idx) => (
                        <li className="py-2" key={idx}>{point}</li>
                    ))}
                </ul>
            ...
            <div className="py-5">
                <h6 className="custom-font-size sec-txt-theme-clr">Work Culture</h6>
                <ul className="fs-3 third-theme-clr py-5">
                    {aboutProject.workCulture.map((point, idx) => (
                        <li className="py-2" key={idx}>{point}</li>
                    ))}
                </ul>
                <div className="w-100 text-center d-flex justify-content-end">
...
export default HighRadiusDetailView;
